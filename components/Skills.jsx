    ...
    <React.Fragment>
      <section id="skills__section">
        <div className="flex flex-col w-full">
          <div className="bg-[#001845] w-full border-b border-slate-300 py-4">
            <h2 className="text-slate-100 text-lg font-semibold md:text-2xl lg:text-2xl px-4">
              Skills
            </h2>
          </div>
          <div className="flex flex-col gap-10 mx-4 py-8">
            <div className="flex flex-col border-slate-400 border rounded-md shadow-slate-900 shadow-lg">
