      ...
      <div className="bg-slate-900/70 flex items-center justify-center w-full h-full">
        <div className=" flex flex-col justify-center items-center gap-5 w-[70%]">
          ...
          <p className="text-slate-100 text-center text-sm font-medium md:text-lg lg:text-xl tracking-wide ">
            ...
            expectations. I constantly challenge myself to take on new projects
            and broaden my skillset. My focus and creativity allow me to bring
            unique and innovative ideas to the table. I am always learning and
            staying current with the latest technologies to ensure optimal
            performance and user experience.
          </p>
          <div className="flex gap-3">
            <Link href="#about">
              <button className="bg-slate-100 font-semibold text-slate-950 text-sm lg:text-lg md:text-base py-3 px-4 rounded-lg hover:-translate-y-1 ">
                Read More
              </button>
            </Link>
            <Link href="#contact">
              <button className="bg-transparent font-semibold text-slate-100 text-sm lg:text-lg md:text-base py-3 px-4 hover:underline hover:underline-offset-2">
                Contact Me
              </button>
            </Link>
          </div>
